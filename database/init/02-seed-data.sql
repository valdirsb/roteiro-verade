...
('admin', 'admin@mundoemverade.com', '$2a$12$pZsSCfeQlFI6jjTkMiT1VO8/eRAxvq3cnfPngI2eY9behENm1tDmO', 'admin', TRUE)
...
('Liry', '#8B5CF6', '/uploads/base/liry.png', TRUE, 1),
('Zad', '#F97316', '/uploads/base/zad.png', TRUE, 1),
('Kim', '#10B981', '/uploads/base/kim.png', TRUE, 1),
('Camila', '#EF4444', '/uploads/base/camila.png', TRUE, 1)
ON DUPLICATE KEY UPDATE 
    color = VALUES(color),
...
(@script_id, NULL, 'Todos riem e se cumprimentam', 4),
